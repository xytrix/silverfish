namespace HREngine.Bots
{
    ...
    public class Ai
    {
        ...
        public Playfield oldMoveGuess = new Playfield();
        ...
        public bool nextMoveContainsGeneratedEntities()
        {
            ...
            if (potentialMove.card != null && potentialMove.card.isGeneratedEntity) return true;
            if (potentialMove.own != null && potentialMove.own.handcard.isGeneratedEntity) return true;
            if (potentialMove.target != null && potentialMove.target.handcard.isGeneratedEntity) return true;
        ...
        {
            if (p.ownMinions.Find(m => m.handcard.isGeneratedEntity) != null) return true;
            if (p.enemyMinions.Find(m => m.handcard.isGeneratedEntity) != null) return true;
            return false;
        }
        ...
        public void updateEntitiy(int old, int newone)
        {
            ...
            if (this.nextMoveGuess != null)
            {
                foreach (Minion m in this.nextMoveGuess.ownMinions)
                {
                    ...
                    {
                        m.entitiyID = newone;
                        m.handcard.isGeneratedEntity = false;
                    }
                }
